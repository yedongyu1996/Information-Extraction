...
import sys
sys.path.append("../..")
from model.bart_wang import BartSeq2SeqModel, Restricter
from model.metrics import TripletSpanMetric
...
parser.add_argument('--dataset_name', default='wenqiChen1', type=str)
